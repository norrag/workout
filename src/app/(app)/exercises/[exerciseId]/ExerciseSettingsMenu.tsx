 ...
 * met prescription. Picking a preset, or typing a CUSTOM value for the odd
 * machine/plate jump the presets don't cover, overrides the equipment default for
 * this lift only; "USE DEFAULT" clears it. The change re-stamps this exercise's
 * planned prescriptions on next view (the read-path freshness reconcile), so it
 * never touches logged history.
 */
