...
type ProgressionHistoryInput = NonNullable<EngineInputs["progressionHistory"]>;
 ...
 * all buckets.
 */
const PROGRESSION_LOOKBACK_DAYS = 90;
 ...
 */
async function getProgressionHistories(
  client: Client,
  userId: string,
  exerciseIds: string[],
  targetMicrocycleId: string | null,
...
function daysSincePerformed(performedAt: string | null): number | null {
