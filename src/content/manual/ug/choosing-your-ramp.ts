...
//   - NO measuring band / `max_measuring_rir` — it is out of scope HERE: this
//     chapter's working-week control is 0–5 RIR (review §1), so every ramp value
//     remains measurable under live v27's cutoff of 5. Ch. 9 owns the appended
//     deload at 8 and its exclusion from the strength anchor. The mechanism this
//     chapter uses is the CONFIDENCE ladder, which gates the earned step
//     (review §3.1)
