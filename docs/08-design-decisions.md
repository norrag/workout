...
| Workout notes | Free text on the complete sheet (1.5), saved with the session. The complete sheet shows only counts (exercises / sets / skipped) + notes + `NEXT WORKOUT →` — **no autoregulation panel, no stats link** (autoregulation still recomputes silently; see 09 2026-06-13 §2). |
