...
| **G** | Bugs | _tbd_ | Discrete defects to reproduce + fix. Shipped: page-switch double-marker glitch (PH29, PR #84), switch-exercise prescription (PH38, PR #84), match-weights crash (PH35), height units (PH28). Open: none discrete (PH29's instant-switch *perf* remainder folded into WS-J). |
