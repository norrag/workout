...
| **R** | Notes-area tooling | [`../05-mcp-connector.md`](../05-mcp-connector.md) | The notes area operated from outside a Claude Code session: the admin MCP intake/management surface (N67) and anything else that changes how notes are captured, assessed and tracked. |
