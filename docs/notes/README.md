...
| **E** | Logging & feedback UX | _tbd_ | Feedback slider resolution, note icon, back-button clutter, set-type removal, over/under marker, soreness capture. Shipped: replace-sheet filters + confirm step (N48/N49, 2026-07-12); **background set-logging queue** (N68) + thumb-only sliders (N69), PR #211. Open: offline READS (T-N68a, needs an owner call). |
