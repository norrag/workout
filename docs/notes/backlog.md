...
| R18 | Modal a11y + touch: no focus management/Escape/trap on any sheet/menu; LOG checkbox 21px & ⋮/▲▼ below-minimum targets; `maximumScale:1` kills pinch-zoom. Scopes doc-07 Phase-7 a11y audit | UX | MED | E | done (PR #100) — zoom-cap bullet **ruled wontfix** (owner 2026-07-02: installed-PWA native feel; cap stays, ruling recorded on the viewport config); full doc-07 Phase-7 audit of the logging flow still open as its own phase item |
