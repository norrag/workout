...
const profiles: { name: string; p: MacroProfile }[] = [
  {
    ...
    p: { sex: "male", age: 25, bodyweight: 180, bodyweightUnit: "lb", heightCm: 178, experienceLevel: "beginner", trainingYears: 0.5 },
  },
  {
    name: "Intermediate M 198lb, 34yo, 2.5yr",
    p: { sex: "male", age: 34, bodyweight: 198, bodyweightUnit: "lb", heightCm: 180, experienceLevel: "intermediate", trainingYears: 2.5 },
  },
  {
    name: "Intermediate M 198lb, 34yo, 4yr (mockup)",
    p: { sex: "male", age: 34, bodyweight: 198, bodyweightUnit: "lb", heightCm: 180, experienceLevel: "intermediate", trainingYears: 4 },
  },
  {
    name: "Advanced M 200lb, 30yo, 7yr",
    p: { sex: "male", age: 30, bodyweight: 200, bodyweightUnit: "lb", heightCm: 180, experienceLevel: "advanced", trainingYears: 7 },
  },
  {
    name: "Elite M 198lb, 40yo, 13yr (user)",
    p: { sex: "male", age: 40, bodyweight: 198, bodyweightUnit: "lb", heightCm: 180, experienceLevel: "intermediate", trainingYears: 13 },
  },
  {
    name: "Intermediate F 140lb, 30yo, 3yr",
    p: { sex: "female", age: 30, bodyweight: 140, bodyweightUnit: "lb", heightCm: 165, experienceLevel: "intermediate", trainingYears: 3 },
  },
  {
    name: "Older M 210lb, 55yo, 6yr",
    p: { sex: "male", age: 55, bodyweight: 210, bodyweightUnit: "lb", heightCm: 178, experienceLevel: "advanced", trainingYears: 6 },
  },
];
